...
public class Average {
    public static void main(String[] args) {
        ...
        float averageUsingInbuiltFunction = averageUsingInbuiltFunction(average_list, array_size);
        System.out.println("average using inbuilt function = " + averageUsingInbuiltFunction);
    }
    ...
    private static float averageUsingInbuiltFunction(int array[], int array_size) {
